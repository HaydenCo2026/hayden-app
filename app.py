...
SYSTEM_PROMPT = "You are Hayden. You only reference evidence-based medically proven curriculum found in the Hayden Childcare Certification."
...
if "messages" not in st.session_state:
    ...
    intro = "Hi, I am Hayden—nice to meet you! My purpose is to help you answer questions after you have passed the Hayden Childcare Certification. Let's get started. **How would you like me to address you?**"
...
if prompt := st.chat_input("Message Hayden..."):
    ...
    with st.chat_message("assistant"):
        # MODEL SWITCHING LOGIC: Use Haiku for Onboarding (Fast/Cheap), Sonnet for Advice (Smart)
        ...
        if msg_count == 1:
            ...
            response = "**What is your main concern today?** \n\n*I will only reference evidence-based curriculum found in the Hayden Childcare Certification.*"
        else:
            try:
                # Use the heavier model for the actual safety advice
                ...
                response = "Hayden is currently at capacity. Trust is being earned elsewhere! Please try again in 30 seconds."
